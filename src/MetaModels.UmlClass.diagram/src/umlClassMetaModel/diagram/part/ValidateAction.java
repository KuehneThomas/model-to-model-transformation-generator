...
public class ValidateAction extends Action {
	...
	public ValidateAction(IWorkbenchPage page) {
		setText(umlClassMetaModel.diagram.part.Messages.ValidateActionMessage);
		this.page = page;
	}
	...
	public static void runValidation(View view) {
		try {
			if (umlClassMetaModel.diagram.part.UmlClassMetaModelDiagramEditorUtil
	...
	public static void runValidation(DiagramEditPart diagramEditPart, View view) {
		...
		umlClassMetaModel.diagram.providers.UmlClassMetaModelValidationProvider
	...
	private static void validate(DiagramEditPart diagramEditPart, View view) {
		...
		if (target != null) {
			umlClassMetaModel.diagram.providers.UmlClassMetaModelMarkerNavigationProvider
	...
	private static void createMarkers(IFile target, IStatus validationStatus,
		...
		umlClassMetaModel.diagram.part.UmlClassMetaModelDiagramEditorUtil.LazyElement2ViewMap element2ViewMap = new umlClassMetaModel.diagram.part.UmlClassMetaModelDiagramEditorUtil.LazyElement2ViewMap(
				diagramEditPart.getDiagramView(), collectTargetElements(
						rootStatus, new HashSet<EObject>(), allStatuses));
		for (Iterator it = allStatuses.iterator(); it.hasNext();) {
			IConstraintStatus nextStatus = (IConstraintStatus) it.next();
			View view = umlClassMetaModel.diagram.part.UmlClassMetaModelDiagramEditorUtil
