 ...
 * @generated
 */
public class UmlClassMetaModelElementChooserDialog extends Dialog {
	 ...
	 * @generated
	 */
	public UmlClassMetaModelElementChooserDialog(Shell parentShell, View view) {
		super(parentShell);
	...
	protected Control createDialogArea(Composite parent) {
		...
		getShell()
				.setText(
						umlClassMetaModel.diagram.part.Messages.UmlClassMetaModelElementChooserDialog_SelectModelElementTitle);
	...
	private boolean isValidModelFile(IFile file) {
		...
		return "umlClassMetaModel".equals(fileExtension); //$NON-NLS-1$
	}
