 ...
 * @generated
 */
public class UmlClassIncomingRelationsReorientCommand extends
		EditElementCommand {
	 ...
	 * @generated
	 */
	public UmlClassIncomingRelationsReorientCommand(
	...
	protected boolean canReorientSource() {
		...
		return umlClassMetaModel.diagram.edit.policies.UmlClassMetaModelBaseItemSemanticEditPolicy
				.getLinkConstraints().canExistUmlClassIncomingRelations_4002(
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().getIncomingRelations().remove(getOldTarget());
		getNewSource().getIncomingRelations().add(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().getIncomingRelations().remove(getOldTarget());
		getOldSource().getIncomingRelations().add(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
