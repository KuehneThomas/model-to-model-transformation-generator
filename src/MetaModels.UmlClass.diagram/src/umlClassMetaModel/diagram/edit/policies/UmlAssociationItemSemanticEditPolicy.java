 ...
 * @generated
 */
public class UmlAssociationItemSemanticEditPolicy
		extends
	 ...
	 * @generated
	 */
	public UmlAssociationItemSemanticEditPolicy() {
		super(
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (umlClassMetaModel.diagram.part.UmlClassMetaModelVisualIDRegistry
					.getVisualID(incomingLink) == umlClassMetaModel.diagram.edit.parts.UmlClassOutgoingRelationsEditPart.VISUAL_ID) {
			...
			if (umlClassMetaModel.diagram.part.UmlClassMetaModelVisualIDRegistry
					.getVisualID(incomingLink) == umlClassMetaModel.diagram.edit.parts.UmlClassIncomingRelationsEditPart.VISUAL_ID) {
				DestroyReferenceRequest r = new DestroyReferenceRequest(
						incomingLink.getSource().getElement(), null,
						incomingLink.getTarget().getElement(), false);
				cmd.add(new DestroyReferenceCommand(r));
