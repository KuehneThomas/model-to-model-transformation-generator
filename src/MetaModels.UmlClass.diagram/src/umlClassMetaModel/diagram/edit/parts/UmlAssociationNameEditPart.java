 ...
 * @generated
 */
public class UmlAssociationNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public UmlAssociationNameEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new umlClassMetaModel.diagram.edit.policies.UmlClassMetaModelTextSelectionEditPolicy());
	...
	public IParser getParser() {
		if (parser == null) {
			parser = umlClassMetaModel.diagram.providers.UmlClassMetaModelParserProvider
					.getParser(
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager2(
					this,
					null,
					umlClassMetaModel.diagram.edit.parts.UmlClassMetaModelEditPartFactory
