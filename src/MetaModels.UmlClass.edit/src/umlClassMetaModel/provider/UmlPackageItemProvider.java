...
/**
 * This is the item provider adapter for a {@link umlClassMetaModel.UmlPackage} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UmlPackageItemProvider
    ...
    IItemPropertySource
{
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_UmlPackage_Name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_UmlPackage_Name_feature", "_UI_UmlPackage_type"),
				 UmlClassMetaModelPackage.Literals.UML_PACKAGE__NAME,
				 true,
				 false,
				 false,
  ...
  public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object)
  {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(UmlClassMetaModelPackage.Literals.UML_PACKAGE__CLASSES);
			childrenFeatures.add(UmlClassMetaModelPackage.Literals.UML_PACKAGE__ASSOCIATIONS);
		}
  ...
  protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object)
  {
		...
		newChildDescriptors.add
			(createChildParameter
				(UmlClassMetaModelPackage.Literals.UML_PACKAGE__CLASSES,
				 UmlClassMetaModelFactory.eINSTANCE.createUmlClass()));

		newChildDescriptors.add
			(createChildParameter
				(UmlClassMetaModelPackage.Literals.UML_PACKAGE__ASSOCIATIONS,
				 UmlClassMetaModelFactory.eINSTANCE.createUmlAssociation()));
	}
