...
public class BalancedFitnessFunction implements IFitnessFunction {
	@Override
	...
	public String toString() {
		return String.format("BalancedFitnessFunction[(mofClassFitness * 3 - mofClassError + mofPropertyFitness) / 4.]");
	}
