...
public class StructureFocusedFitnessFunction implements IFitnessFunction {
	@Override
	public IEObjectMatcher createObjectMatcher() {
		...
		IEObjectMatcher matcher = new IdentifierEObjectMatcher(contentMatcher, eObject -> {
	...
	public String toString() {
		return String.format("StructureFocusedFitnessFunction[((mofClassFitness - mofClassError) * 10 + mofPropertyFitness) / 11.]");
	}
}
