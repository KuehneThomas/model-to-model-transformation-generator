 ...
 * @generated
 */
public class RelationalMetaModelNavigatorActionProvider extends
	...
	private static class OpenDiagramAction extends Action {
		...
		public OpenDiagramAction(ICommonViewerWorkbenchSite viewerSite) {
			super(
					relationalMetaModel.diagram.part.Messages.NavigatorActionProvider_OpenDiagramActionName);
		...
		public final void selectionChanged(IStructuredSelection selection) {
			...
			if (selection.size() == 1) {
				...
				if (selectedElement instanceof relationalMetaModel.diagram.navigator.RelationalMetaModelNavigatorItem) {
					selectedElement = ((relationalMetaModel.diagram.navigator.RelationalMetaModelNavigatorItem) selectedElement)
							.getView();
