 ...
 * @generated
 */
public class RelationalTableNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public RelationalTableNameEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new relationalMetaModel.diagram.edit.policies.RelationalMetaModelTextSelectionEditPolicy());
	...
	public IParser getParser() {
		if (parser == null) {
			parser = relationalMetaModel.diagram.providers.RelationalMetaModelParserProvider
					.getParser(
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager2(
					this,
					null,
					relationalMetaModel.diagram.edit.parts.RelationalMetaModelEditPartFactory
