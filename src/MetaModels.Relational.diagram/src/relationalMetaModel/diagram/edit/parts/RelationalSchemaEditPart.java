 ...
 * @generated
 */
public class RelationalSchemaEditPart extends DiagramEditPart {

	/**
	 * @generated
	 */
	public final static String MODEL_ID = "RelationalMetaModel"; //$NON-NLS-1$
	 ...
	 * @generated
	 */
	public RelationalSchemaEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new relationalMetaModel.diagram.edit.policies.RelationalSchemaItemSemanticEditPolicy());
		installEditPolicy(
				EditPolicyRoles.CANONICAL_ROLE,
				new relationalMetaModel.diagram.edit.policies.RelationalSchemaCanonicalEditPolicy());
		installEditPolicy(
						...
						if (command != null) {
							return command
									.chain(new ICommandProxy(
											new relationalMetaModel.diagram.edit.commands.RelationalMetaModelCreateShortcutDecorationsCommand(
													getEditingDomain(),
													(View) getModel(),
													viewDescriptors)));
						}
