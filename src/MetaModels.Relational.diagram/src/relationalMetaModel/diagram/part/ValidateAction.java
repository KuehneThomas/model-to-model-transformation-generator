...
public class ValidateAction extends Action {
	...
	public ValidateAction(IWorkbenchPage page) {
		setText(relationalMetaModel.diagram.part.Messages.ValidateActionMessage);
		this.page = page;
	}
	...
	public static void runValidation(View view) {
		try {
			if (relationalMetaModel.diagram.part.RelationalMetaModelDiagramEditorUtil
	...
	public static void runValidation(DiagramEditPart diagramEditPart, View view) {
		...
		relationalMetaModel.diagram.providers.RelationalMetaModelValidationProvider
	...
	private static void validate(DiagramEditPart diagramEditPart, View view) {
		...
		if (target != null) {
			relationalMetaModel.diagram.providers.RelationalMetaModelMarkerNavigationProvider
	...
	private static void createMarkers(IFile target, IStatus validationStatus,
		...
		relationalMetaModel.diagram.part.RelationalMetaModelDiagramEditorUtil.LazyElement2ViewMap element2ViewMap = new relationalMetaModel.diagram.part.RelationalMetaModelDiagramEditorUtil.LazyElement2ViewMap(
				diagramEditPart.getDiagramView(), collectTargetElements(
						rootStatus, new HashSet<EObject>(), allStatuses));
		for (Iterator it = allStatuses.iterator(); it.hasNext();) {
			IConstraintStatus nextStatus = (IConstraintStatus) it.next();
			View view = relationalMetaModel.diagram.part.RelationalMetaModelDiagramEditorUtil
