 ...
 * @generated
 */
public class RelationalMetaModelElementChooserDialog extends Dialog {
	 ...
	 * @generated
	 */
	public RelationalMetaModelElementChooserDialog(Shell parentShell, View view) {
		super(parentShell);
	...
	protected Control createDialogArea(Composite parent) {
		...
		getShell()
				.setText(
						relationalMetaModel.diagram.part.Messages.RelationalMetaModelElementChooserDialog_SelectModelElementTitle);
	...
	private boolean isValidModelFile(IFile file) {
		...
		return "relationalMetaModel".equals(fileExtension); //$NON-NLS-1$
	}
